...
W celu zepewnienia maksymalnego bezpieczeństwa (gdy bramka dostępna jest z Internetu) a jednocześnie umożliwienia łatwej autentykacji (gdy bramka działa tylko lokalnie) udostępniamy do wyboru kilka mechanizmów autentykacji.
