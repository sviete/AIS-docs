...
sidebar_label: Wykoanie pełnego resetu aplikacji
id: version-0.96.10-ais_bramka_reset_ais_step_by_step
original_id: ais_bramka_reset_ais_step_by_step
---

## Wykoanie pełnego resetu aplikacji
...
Cały proces jest szybki, cały restart trwa około 4 minuty (jeśli mamy łącze Internetowe z transferem na poziomie 10 Mbps).
...
2. Pobranie spakowanej paczki startowej z najnowszą wersją kodów i konfiguracji Asystenta domowego.
3. Rozpakowania najnowszej wersji z domyślnymi ustawieniami.
