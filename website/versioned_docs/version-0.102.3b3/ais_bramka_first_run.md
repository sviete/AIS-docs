...
id: version-0.102.3b3-ais_bramka_first_run
...
> Docelowo (do wersji 1.0.0) cały proces dodawania aplikacji i łączenia jej z bramką będzie częścią początkowej konfiguracji. 
